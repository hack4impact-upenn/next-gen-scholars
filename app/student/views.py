...
@student.route('/profile/college/delete/<int:item_id>/<int:student_profile_id>', methods=['POST'])
@login_required
@csrf.exempt
...
@student.route('/profile/major/delete/<int:item_id>/<int:student_profile_id>', methods=['POST'])
@login_required
@csrf.exempt
